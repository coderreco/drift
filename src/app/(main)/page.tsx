...
//                     <h1 className='sr-only'>The Bike Shack</h1>
//                     <span className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl xl:text-6xl">
//                       The Bike Shack
//                     </span>
//                     <p className="mt-4 text-xl text-gray-600">
//                       We sell the best gear for your next mountain biking adventure. Get ready to hit the trails with
//                       our exclusive selection of top-of-the-line products.
//                     </p>
...
//               </div>
//             </div>
//             <div className="h-48 w-full relative sm:h-64 lg:absolute lg:right-0 lg:top-0 lg:h-full lg:w-1/2">
//               <Image
//                 src={markAir}
//                 alt="a man on a mountain bike in mid-air"
//                 className="inset-0 h-full object-cover object-right"
//               />
//             </div>
//           </div>
//         </div>
