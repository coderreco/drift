        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:ml-auto lg:pl-4 lg:pt-4">
            <div className="lg:max-w-lg py-12">
              <h2 className="text-base font-semibold leading-7 text-indigo-600">{eyebrow}</h2>
          ...
          <div className="flex items-start relative justify-end h-full bg-emerald-200 lg:order-first">
            <Image
              src={markAir}
              alt="Product screenshot"
              className="w-[48rem] max-w-none h-full object-cover object-right shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]"
              width={2432}
              height={1442}
            />
          </div>
...
const CenteredFeature = ({eyebrow, heading, text, video}:{eyebrow: string, heading: string, text: string, video?: string}) => (
  <div className="bg-white relative px-6 py-24 sm:py-32 lg:px-8">
    {video && (
      ...
      <p className="text-base font-semibold leading-7 text-amber-400">{ eyebrow }</p>
    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <p className="text-base font-semibold leading-7 text-indigo-600">{eyebrow}</p>
